...
<div class="card shadow mb-4">
    <div class="card-header py-1" style="text-align: center;">
        <h7 class="m-0 font-weight-bold text-primary">View Data PR</h7>
    </div>
                ...
                <tr>
                    <td>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control-sm" required="required" id="nomor_pr" name="nomor_pr" value="{{ $data['pr']->no_pr }}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputtext" class="col-sm-2 col-form-label">Tanggal</label>
                            <div class="col-sm-10">
                                <input type="datetime-local" value="{{ $data['pr']->tanggal}}" class="form-control form-control-sm" required="required" id="tanggal_pr" name="tanggal_pr" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="vendor_id" class="form-control form-control-sm" id="vendor_id" onchange="getVendor('vendor');" disabled>
                                    <option value=""></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="produk_id" id="produk_id" class="form-control form-control-sm" required onchange="getVendor('produk')" disabled>
                                    <option value=""></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control-sm" required="required" name="qty" id="qty" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row" style="float: right;">
                            ...
                            <div class="col-sm-10">
                                <!-- <button type="button" class="btn btn-outline-success btn-sm" value="Update Data"><i class="fas fa-print">&nbsp;Print</i>
                                </button> -->
                            </div>
                        </div>
                    </td>
