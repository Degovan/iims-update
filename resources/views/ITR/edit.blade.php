                ...
                <tr>
                    <td>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="datetime-local" class="form-control form-control-sm" required="required" id="tanggal_itr" name="tanggal_itr" value="{{$data['itr']->tanggal_itr}}">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function cekboxValid() {
        var isValid = <?php echo json_encode($data['itr']->valid_itr); ?>;
       if (isValid.length > 0) {
           isValid.forEach(e => {
               if (e == 'valid_1') {
                   $("#valid_vendor_name").prop("checked", true);                   
               }               

               if (e == 'valid_2') {
                   $("#valid_vendor_cp").prop("checked", true);                   
               }               

               if (e == 'valid_3') {
                   $("#valid_produk").prop("checked", true);                   
               }          

               if (e == 'valid_4') {
                   $("#valid_qty").prop("checked", true);                   
               }          

               if (e == 'valid_5') {
                   $("#valid_harga").prop("checked", true);                   
               }      
