...
<div class="card shadow mb-4">
	<div class="card-header py-1" style="text-align: center;">
		<h7 class="m-0 font-weight-bold text-primary">Edit Data User Level</h7>
	</div>
	<div class="card-body" style="margin-top: -20px;">@foreach($userlev as $data)
				...
				<tr>
					<td>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control form-control-sm" type="hidden" name="id_userlev" value="{{ $data->id }}">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control form-control-sm" required="required" name="hak_akses" value="{{ $data->hak_akses }}">
							</div>
						</div>
						<div class="form-group row">
